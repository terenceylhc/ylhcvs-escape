...
const DEFAULT_QUESTIONS_POOL = [
  ...
  },
  {
    id: "q_1_7",
    categoryLevel: 1,
    title: "關卡一：【視聽影音與圖書借期算式】",
    location: "服務台與視聽區",
    answer: "5",
    hint: "提示：視聽影音借閱上限部數=2，圖書借期週數=2，視聽影音借期週數=1",
    question: "請參閱本館介紹，計算：(視聽影音借閱上限部數 × 圖書借期週數) + 視聽影音借期週數 ＝ ？"
  },
  {
    id: "q_1_8",
    categoryLevel: 1,
  ...
  },
  {
    id: "q_2_3",
    categoryLevel: 2,
    title: "關卡二：【OPAC 檢索：《比句點更悲傷》】",
    location: "電腦查詢區 / 手機 (WebOPAC)",
    answer: ["大師兄2019", "大師兄19"],
    hint: "提示：請在 WebOPAC 輸入書名《比句點更悲傷》，點入詳細頁面查看作者姓名與出版年份！",
    question: "📖 請在 WebOPAC 搜尋《比句點更悲傷》，將【作者姓名】+【出版年份】拼湊成暗號："
  },
  {
    id: "q_2_4",
    categoryLevel: 2,
  ...
  // ─── 關卡 4：當期與過期期刊尋寶 (20 題隨機抽 3 題亂數防抄襲；隱藏代碼，全數 2 書組合) ───
  {
    ...
    answer: "11",
    hint: "提示：請前往期刊區找出《新小牛頓》的代碼為A10，數字部分=10，《財訊》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《新小牛頓》與《財訊》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_2",
    categoryLevel: 4,
    ...
    location: "當期期刊區 / 過期期刊區",
    answer: "15",
    hint: "提示：請前往期刊區找出《康健》的代碼為B9，數字部分=9，《少年牛頓》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《康健》與《少年牛頓》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_3",
    categoryLevel: 4,
    ...
    location: "當期期刊區 / 過期期刊區",
    answer: "23",
    hint: "提示：請前往期刊區找出《國家地理》的代碼為C17，數字部分=17，《鄉間小路》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《國家地理》與《鄉間小路》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_4",
    categoryLevel: 4,
    ...
    location: "當期期刊區 / 過期期刊區",
    answer: "17",
    hint: "提示：請前往期刊區找出《商業周刊》的代碼為C9，數字部分=9，《美麗佳人》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《商業周刊》與《美麗佳人》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_5",
    categoryLevel: 4,
    ...
    location: "當期期刊區 / 過期期刊區",
    answer: "26",
    hint: "提示：請前往期刊區找出《料理台灣》的代碼為A14，數字部分=14，《經典》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《料理台灣》與《經典》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_6",
    categoryLevel: 4,
    ...
    location: "當期期刊區 / 過期期刊區",
    answer: "17",
    hint: "提示：請前往期刊區找出《遠見》的代碼為B13，數字部分=13，《皇冠》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《遠見》與《皇冠》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_7",
    categoryLevel: 4,
    ...
    location: "當期期刊區 / 過期期刊區",
    answer: "15",
    hint: "提示：請前往期刊區找出《天下》的代碼為B12，數字部分=12，《今周刊》的代碼數字部分是多少呢? 將兩本期刊架位代號的數字部分相加就是答案囉！",
    question: "📰 請至當期期刊區或過期期刊區，尋找《天下》與《今周刊》兩本期刊，將兩本期刊架位代號的【數字部分相加】作為密碼："
  },
  {
    id: "q_4_8",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C9】與【C11】兩本期刊，將【C9 刊名第 1 個字】+【C11 刊名第 3 個字】組合成一個詞語作為密碼："
  },
  {
    id: "q_4_9",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C4】與【A2】兩本期刊，將【C4 刊名第 1 個字】+【A2 刊名第 3 個字】組合成一個詞語作為密碼："
  },
  {
    id: "q_4_10",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C17】與【A2】兩本期刊，將【C17 刊名第 1 個字】+【A2 刊名第 3 個字】組合成一個詞語作為密碼："
  },
  {
    id: "q_4_11",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【A8】與【C11】兩本期刊，將【A8 刊名第 1 個字】+【C11 刊名第 3 個字】組合成一個詞語作為密碼："
  },
  {
    id: "q_4_12",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【B6】與【A7】兩本期刊，將【B6 刊名第 3 個字】+【A7 刊名第 2 個字】拼湊成密碼："
  },
  {
    id: "q_4_13",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【B4】與【A14】兩本期刊，將【B4 刊名第 1 個字】+【A14 刊名第 1 個字】拼湊成密碼："
  },
  {
    id: "q_4_14",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【B5】與【A8】兩本期刊，將【B5 刊名第 2 個字】+【A8 刊名第 2 個字】拼湊成密碼："
  },
  {
    id: "q_4_15",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C7】與【C12】兩本期刊，將【C7 刊名第 1 個字】+【C12 刊名第 1 個字】拼湊成密碼："
  },
  {
    id: "q_4_16",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C18】與【C13】兩本期刊，將【C18 刊名第 1 個字】+【C13 刊名第 3 個字】拼湊成密碼："
  },
  {
    id: "q_4_17",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C18】與【C8】兩本期刊，將【C18 刊名第 2 個字】+【C8 刊名第 3 個字】拼湊成密碼："
  },
  {
    id: "q_4_18",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C8】與【C18】兩本期刊，將【C8 刊名第 3 個字】+【C18 刊名第 3 個字】拼湊成密碼："
  },
  {
    id: "q_4_19",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【C13】與【C7】兩本期刊，將【C13 刊名第 3 個字】+【C7 刊名第 3 個字】拼湊成密碼："
  },
  {
    id: "q_4_20",
    categoryLevel: 4,
    ...
    question: "📰 請至當期期刊區或過期期刊區，尋找架位【A10】與【C7】兩本期刊，將【A10 刊名第 3 個字】+【C7 刊名第 3 個字】拼湊成密碼："
  },
